...
set rc [catch {
  ...
  set_property webtalk.parent_dir D:/10_Bidouilles_a_JOB/RedPitaya/fpga/prj/classic/project/redpitaya.cache/wt [current_project]
  set_property parent.project_path D:/10_Bidouilles_a_JOB/RedPitaya/fpga/prj/classic/project/redpitaya.xpr [current_project]
  set_property ip_output_repo D:/10_Bidouilles_a_JOB/RedPitaya/fpga/prj/classic/project/redpitaya.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  add_files -quiet D:/10_Bidouilles_a_JOB/RedPitaya/fpga/prj/classic/project/redpitaya.runs/synth_1/red_pitaya_top.dcp
  set_msg_config -source 4 -id {BD 41-1661} -suppress
  set_param project.isImplRun true
  add_files D:/10_Bidouilles_a_JOB/RedPitaya/fpga/prj/classic/project/redpitaya.srcs/sources_1/bd/system/system.bd
  set_property is_locked true [get_files D:/10_Bidouilles_a_JOB/RedPitaya/fpga/prj/classic/project/redpitaya.srcs/sources_1/bd/system/system.bd]
  set_param project.isImplRun false
  read_xdc D:/10_Bidouilles_a_JOB/RedPitaya/fpga/prj/classic/project/redpitaya.srcs/constrs_1/imports/sdc/red_pitaya.xdc
  set_param project.isImplRun true
